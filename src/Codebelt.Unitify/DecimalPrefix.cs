...
namespace Codebelt.Unitify
{
    ...
    /// </summary>
    /// <seealso cref="Prefix" />
    public sealed class DecimalPrefix : Prefix
    {
        ...
        /// </summary>
        /// <value>The decimal-submultiple prefix quecto (symbol 'q').</value>
        public static DecimalPrefix Quecto => new("quecto", "q", -30);

        /// <summary>
        /// Gets the decimal-submultiple prefix ronto (symbol 'r'), 10^-27 = 0.000000000000000000000000001.
        /// </summary>
        /// <value>The decimal-submultiple prefix ronto (symbol 'r').</value>
        public static DecimalPrefix Ronto => new("ronto", "r", -27);
        ...
        /// </summary>
        /// <value>The decimal-multiple prefix ronna (symbol 'R').</value>
        public static DecimalPrefix Ronna => new("ronna", "R", 27);

        /// <summary>
        /// Gets the decimal-multiple prefix quetta (symbol 'Q'), 10^30 = 1000000000000000000000000000000.
        /// </summary>
        /// <value>The decimal-multiple prefix quetta (symbol 'Q').</value>
        public static DecimalPrefix Quetta => new("quetta", "Q", 30);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalPrefix"/> class.
        /// </summary>
